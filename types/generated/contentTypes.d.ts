...
export interface ApiExplanationExplanation extends Schema.CollectionType {
  ...
  attributes: {
    title_lesson: Attribute.String;
    description_lesson: Attribute.Text;
    ...
    lesson: Attribute.Relation<
      ...
      'api::lesson.lesson'
    >;
    home_works: Attribute.Relation<
      'api::explanation.explanation',
      'oneToMany',
      'api::home-work.home-work'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiHomeWorkHomeWork extends Schema.CollectionType {
  collectionName: 'home_works';
  info: {
    singularName: 'home-work';
    pluralName: 'home-works';
  ...
  attributes: {
    image: Attribute.Media;
    title_home_work: Attribute.String;
    explanation: Attribute.Relation<
      'api::home-work.home-work',
      'manyToOne',
      'api::explanation.explanation'
    >;
...
export interface ApiLessonLesson extends Schema.CollectionType {
  ...
  attributes: {
    lesson_title: Attribute.String;
    lesson_description: Attribute.Text;
    image: Attribute.Media;
    image_interactive: Attribute.Media;
    subject: Attribute.Relation<
      'api::lesson.lesson',
      'manyToOne',
      'api::subject.subject'
    >;
    explanations: Attribute.Relation<
      'api::lesson.lesson',
      'oneToMany',
      'api::explanation.explanation'
    >;
...
export interface ApiProfileImgProfileImg extends Schema.CollectionType {
  collectionName: 'profile_imgs';
  info: {
    singularName: 'profile-img';
    pluralName: 'profile-imgs';
    displayName: 'profile-img';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::home-work.home-work': ApiHomeWorkHomeWork;
      'api::lesson.lesson': ApiLessonLesson;
      'api::profile-img.profile-img': ApiProfileImgProfileImg;
